...
function NewsLetterModel() {
  return (
    <div classNameName="modal fade show" id="newsletterPopup" tabindex="-1" aria-hidden="true">
        ...
        <div className="row p-0 m-0">
          ...
          <div className="col-md-6 p-0 d-flex align-items-center">
            <div className="block-newsletter w-100">
              ...
              <form action="https://uomo-html.flexkitux.com/Demo18/index.html" className="footer-newsletter__form position-relative bg-body">
                <input className="form-control border-2" type="email" name="email" placeholder="Your email address" />
                <input className="btn-link fw-medium bg-transparent position-absolute top-0 end-0 h-100" type="submit" value="JOIN" />
              </form>
            </div>
          </div>
        </div>
